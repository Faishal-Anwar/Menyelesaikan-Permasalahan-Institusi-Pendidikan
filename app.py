...
if selected == 'Predict':
    ...
    with col2:
        Admission_grade = float(st.number_input(label='Admission_grade', value=142.5))
    ...
    with col2:
        Previous_qualification_grade = float(st.number_input(label='Previous_qualification_grade', value=160.0))
    ...
    col1, col2, col3 = st.columns(3)
    with col1:
        data["Curricular_units_1st_sem_credited"] = [int(st.number_input(label='1st Credited', value=0))]
    with col2:
        data["Curricular_units_1st_sem_enrolled"] = [int(st.number_input(label='1st Enrolled', value=6))]
    with col3:
        data["Curricular_units_1st_sem_evaluations"] = [int(st.number_input(label='1st Evaluations', value=6))]
    col1, col2, col3 = st.columns(3)
    with col1:
        data["Curricular_units_1st_sem_approved"] = [float(st.number_input(label='1st Approved', value=6.0))]
    with col2:
        data["Curricular_units_1st_sem_grade"] = [float(st.number_input(label='1st Grade', value=14.0))]
    with col3:
        data["Curricular_units_1st_sem_without_evaluations"] = [float(st.number_input(label='1st Without_evaluations', value=0.0))]
    ...
    col1, col2, col3 = st.columns(3)
    with col1:
        data["Curricular_units_2nd_sem_credited"] = [int(st.number_input(label='2nd Credited', value=0))]
    with col2:
        data["Curricular_units_2nd_sem_enrolled"] = [int(st.number_input(label='2nd Enrolled', value=6))]
    with col3:
        data["Curricular_units_2nd_sem_evaluations"] = [int(st.number_input(label='2nd Evaluations', value=6))]
    col1, col2, col3 = st.columns(3)
    with col1:
        data["Curricular_units_2nd_sem_approved"] = [float(st.number_input(label='2nd Approved', value=6.0))]
    with col2:
        data["Curricular_units_2nd_sem_grade"] = [float(st.number_input(label='2nd Grade', value=13.67))]
    with col3:
        data["Curricular_units_2nd_sem_without_evaluations"] = [float(st.number_input(label='2nd Without_evaluations', value=0.0))]
